-- Fix profiles table RLS policies - ensure only authenticated users can access their own data
...
-- Fix billing_info table RLS policies - ensure only authenticated users can access their own data
